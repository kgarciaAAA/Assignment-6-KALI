...
public class SectionFileHandler {
    public void readSectionsFromFile(CourseStorage courseStorage) throws IOException {
        try (Scanner snr = new Scanner(new File("txtfiles/sections.txt"))) {
            ...
            throw new IOException("Error reading: \"txtfiles/sections.txt\"");
    ...
    public void writeSectionsToFile(CourseStorage courseStorage) throws IOException{
        try (PrintWriter out = new PrintWriter(new File("txtfiles/sections.txt"))) {
            ...
            throw new IOException("Error writing to: \"txtfiles/sections.txt\"");
        }
    }
}
