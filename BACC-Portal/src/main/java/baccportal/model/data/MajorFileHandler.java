...
import baccportal.model.academics.MajorCatalog;
...
public class MajorFileHandler {
    public void readMajorsFromFile(MajorStorage majorStorage, CourseStorage courseStorage) throws IOException {
        try (Scanner snr = new Scanner(new File("txtfiles/majors.txt"))) {
            ...
            throw new IOException("Error reading: \"txtfiles/majors.txt\"");
    ...
    public void writeMajorsToFile(MajorStorage majorStorage) throws IOException {
        try (PrintWriter out = new PrintWriter(new File("txtfiles/majors.txt"))) {
            ...
            throw new IOException("Error writing to: \"txtfiles/majors.txt\"");
        }
    }
}
