...
public class CourseFileHandler {
    ...
    public void readCoursesFromFile(CourseStorage storage) throws IOException {
        try (Scanner snr = new Scanner(new File("txtfiles/courses.txt"))){
            ...
            throw new IOException("Error reading: \"txtfiles/courses.txt\"");
    ...
    public void writeCoursesToFile(CourseStorage storage) throws IOException {
        try (PrintWriter out = new PrintWriter(new File("txtfiles/courses.txt"))) {
            ...
            throw new IOException("Error writing to: \"txtfiles/courses.txt\"");
        }
    }
